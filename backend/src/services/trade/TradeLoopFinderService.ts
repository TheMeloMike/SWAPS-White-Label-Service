...
export class TradeLoopFinderService {
  ...
  // Configuration (MVP Optimized for Better Trade Discovery)
  private readonly MAX_SCC_CONCURRENCY = 6; // Process up to 6 SCCs in parallel (MVP: +50% concurrency)
  private readonly MAX_API_CONCURRENCY = 15; // Maximum concurrent API calls (MVP: +50% for faster data fetching)
  private readonly MAX_CYCLES_DENSE_GRAPH = 1000; // Max cycles to find in dense graphs (MVP: 2x more trade opportunities)
